...
func (m *GetTransactionsRequest) GetUid() string {
	if m != nil {
		return m.Uid
	}
	return ""
...
func (m *GetTransactionsReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetTransactionsReply.Merge(m, src)
}
...
func (m *GetTransactionsReply) GetErr() string {
	if m != nil {
		return m.Err
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GetTransactionsRequest)(nil), "pb.GetTransactionsRequest")
	proto.RegisterType((*GetTransactionsReply)(nil), "pb.GetTransactionsReply")
}
...
var fileDescriptor_6362648dfa63d410 = []byte{
	...
	,
}
...
func (this *GetTransactionsReply) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*GetTransactionsReply)
	if !ok {
		that2, ok := that.(GetTransactionsReply)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *GetTransactionsRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&pb.GetTransactionsRequest{")
	s = append(s, "Uid: "+fmt.Sprintf("%#v", this.Uid)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *GetTransactionsReply) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&pb.GetTransactionsReply{")
...
func (c *paymentClient) GetTransactions(ctx context.Context, in *GetTransactionsRequest, opts ...grpc.CallOption) (*GetTransactionsReply, error) {
	out := new(GetTransactionsReply)
	err := c.cc.Invoke(ctx, "/pb.Payment/GetTransactions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedPaymentServer) GetTransactions(ctx context.Context, req *GetTransactionsRequest) (*GetTransactionsReply, error) {
...
func _Payment_GetTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTransactionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServer).GetTransactions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Payment/GetTransactions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).GetTransactions(ctx, req.(*GetTransactionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Payment_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Payment_GetTransactions_Handler,
		},
	},
...
func (m *GetTransactionsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetTransactionsReply) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetTransactionsReply) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetTransactionsReply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetTransactionsReply) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *GetTransactionsReply) String() string {
	if this == nil {
		return "nil"
	}
	...
	s := strings.Join([]string{`&GetTransactionsReply{`,
...
func (m *GetTransactionsReply) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetTransactionsReply: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetTransactionsReply: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
