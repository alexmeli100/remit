...
import (
	"context"
	"errors"
	endpoint "github.com/alexmeli100/remit/notificator/pkg/endpoint"
	pb "github.com/alexmeli100/remit/notificator/pkg/transport/grpc/pb"
	grpc "github.com/go-kit/kit/transport/grpc"
	context1 "golang.org/x/net/context"
)

// makeSendConfirmEmailHandler creates the handler logic
func makeSendConfirmEmailHandler(endpoints endpoint.Endpoints, options []grpc.ServerOption) grpc.Handler {
	return grpc.NewServer(endpoints.SendConfirmEmailEndpoint, decodeSendConfirmEmailRequest, encodeSendConfirmEmailResponse, options...)
}
...
func (g *grpcServer) SendConfirmEmail(ctx context1.Context, req *pb.SendConfirmEmailRequest) (*pb.SendConfirmEmailReply, error) {
...
func makeSendPasswordResetEmailHandler(endpoints endpoint.Endpoints, options []grpc.ServerOption) grpc.Handler {
	return grpc.NewServer(endpoints.SendPasswordResetEmailEndpoint, decodeSendPasswordResetEmailRequest, encodeSendPasswordResetEmailResponse, options...)
}
...
func (g *grpcServer) SendPasswordResetEmail(ctx context1.Context, req *pb.SendPasswordResetEmailRequest) (*pb.SendPasswordResetEmailReply, error) {
...
func makeSendWelcomeEmailHandler(endpoints endpoint.Endpoints, options []grpc.ServerOption) grpc.Handler {
	return grpc.NewServer(endpoints.SendWelcomeEmailEndpoint, decodeSendWelcomeEmailRequest, encodeSendWelcomeEmailResponse, options...)
}
...
func (g *grpcServer) SendWelcomeEmail(ctx context1.Context, req *pb.SendWelcomeEmailRequest) (*pb.SendWelcomeEmailReply, error) {
